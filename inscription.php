...
<body>
    ...
    <div class="container">
        <h5>historical inscription</h5>
        <hr>        <ul class="responsive-table">
          <li class="table-header">
            ...
            <div class="col col-5">Hourly mass</div>
          ...
          <li class="table-row">
            ...
            <div class="col col-4" data-label="Payment Status">2023-02-02</div>
            <div class="col col-4" data-label="Payment Status">Bouik</div>
            <div class="col col-4" data-label="Payment Status">20</div>
